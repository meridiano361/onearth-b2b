...
const NAV_CARDS = [
  ...
  },
  {
    href: '/admin/products',
    label: 'Prodotti',
    description: 'Catalogo, prezzi, foto e importazione',
    icon: Package,
  ...
  },
  {
    ...
    label: 'Analisi',
    description: 'Report vendite, clienti e performance',
    icon: BarChart2,
    color: 'bg-emerald-50 text-emerald-600',
  },
  {
    href: '/admin/anteprima',
    label: 'Anteprima',
    description: 'Visualizza l\'app come la vedono i clienti',
    icon: Eye,
  ...
  },
  {
    ...
    label: 'Clienti',
    description: 'Lista organizzazioni e accessi',
    icon: Users,
  ...
  },
  {
    ...
    description: 'Approva o rifiuta nuove registrazioni',
    icon: UserPlus,
  ...
  },
  {
    href: '/admin/sondaggi',
    label: 'Sondaggi',
    description: 'Crea sondaggi e raccogli risposte',
    icon: MessageSquare,
  ...
  },
  {
    ...
    label: 'Notifiche',
    description: 'Invia notifiche push ai clienti',
    icon: Bell,
  ...
  },
  {
    href: '/admin/foto',
    label: 'Foto',
    description: 'Carica e ottimizza le immagini prodotto',
    icon: ImageIcon,
  ...
  },
  {
    ...
    description: 'Gestisci linee, collezioni e categorie',
    icon: Layers,
    color: 'bg-cyan-50 text-cyan-600',
  },
  {
    href: '/admin/catalogo-pdf',
    label: 'Catalogo PDF',
    description: 'Genera e scarica il catalogo in PDF',
    icon: BookOpen,
  ...
  },
  {
    ...
    label: 'Documenti',
    description: 'Documenti e risorse per i clienti',
    icon: FileText,
    color: 'bg-yellow-50 text-yellow-600',
  },
  {
    href: '/admin/personalizzazione',
    label: 'Personalizzazione',
    description: 'Homepage, colori, collezioni e messaggi',
    icon: Paintbrush,
  ...
  },
  {
    ...
    label: 'Impostazioni',
    description: 'Configurazione avanzata dell\'app',
    icon: Settings,
