...
import { Eye, ChevronDown, ChevronUp, Loader2, MonitorSmartphone, UserCheck, FlaskConical } from 'lucide-react';
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
        ...
        {/* ── Pannello 2: Anteprima cliente (collapsibile) ────────────────── */}
        <div className="bg-white border border-border rounded-xl overflow-hidden">
          <button
            onClick={() => setClienteOpen((v) => !v)}
            className="w-full flex items-center gap-3 p-6 text-left hover:bg-gray-50/50 transition-colors"
          >
            ...
            {clienteOpen ? <ChevronUp size={15} className="text-gray-400 flex-shrink-0" /> : <ChevronDown size={15} className="text-gray-400 flex-shrink-0" />}
          </button>

          {clienteOpen && (
            <div className="px-6 pb-6 border-t border-border/50">
              <p className="text-xs text-gray-500 leading-relaxed mt-4 mb-4">
              ...
              {loadingOrgs ? (
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-primary text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                  >
