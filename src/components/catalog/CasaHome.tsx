...
import { Grid3x3, Heart, ShoppingCart, Package2, ArrowLeft, ChevronRight, Clock, Lock } from 'lucide-react';
import { useSettings } from '@/contexts/SettingsContext';

const COLLECTION_ITEMS = [
  { href: '/catalog/products',  icon: Grid3x3,     label: 'Catalogo',  description: 'Sfoglia e ordina tutta la collezione Casa 2027' },
  ...
  { href: '/catalog/orders',    icon: Package2,     label: 'Ordini',    description: 'I tuoi ordini Casa 2027'                       },
];
