        ...
        {NAV_ITEMS.map(({ icon: Icon, label, href, isActive, badge, notifBadge }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                'flex-1 flex flex-col items-center justify-center gap-[2px] py-1 transition-colors relative overflow-hidden',
            ...
            >
              ...
              <span className="text-[9px] leading-none truncate w-full text-center px-0.5">{label}</span>
            </Link>
          );
        })}
      </div>
