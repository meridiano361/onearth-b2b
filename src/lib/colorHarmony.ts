...
const COLORE_KEYWORD_ORDER = [
  ...
  'terracotta', 'corallo', 'rosso', 'arancione', 'pesca', 'ocra', 'senape', 'oro', 'giallo',
  'verde', 'azzurro', 'blu', 'indaco', 'lilla', 'viola', 'fucsia', 'rosa',
  'militare', 'kaki', 'antracite', 'grafite', 'grigio', 'argento',
  'avorio', 'panna', 'crema', 'champagne', 'ecru', 'beige', 'sabbia', 'taupe',
  'cioccolato', 'cognac', 'cuoio', 'caramello', 'cammello', 'bronzo', 'rame', 'ruggine', 'marrone',
  'tortora', 'bianco', 'nero', 'trasparente',
];
