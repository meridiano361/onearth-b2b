...
export async function GET(req: NextRequest) {
  ...
  try {
    const collection = await prisma.collection.upsert({
      ...
      update: {},
      create: { name: 'CASA 2027', slug: 'casa-2027', season: 'FW', year: 2027, isActive: true },
    });
    ...
    const products = [
      { code: 'OE-SOF-001', name: 'Anima Sofa 3-Seater', costPrice: 1850, retailPrice: 3700, lotSize: 1, categoryId: catSofas.id, notes: 'Available in 6 fabric options' },
