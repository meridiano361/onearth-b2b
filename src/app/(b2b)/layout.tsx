  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <a
        ...
        title="Assistenza"
        className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110 active:scale-95"
