      ...
      <div className="space-y-8">
        ...
        <section id="moda-pe27" className="bg-white border border-border rounded-lg p-5 sm:p-6 scroll-mt-6">
          ...
          <ul className="space-y-2">
            ...
            <Bullet><span className="font-medium">Visual:</span> simula l&apos;esposizione in negozio costruendo layout con barre appenderia, mensole e frontali. L&apos;anteprima è fissa in cima alla pagina. Per aggiungere prodotti usa il pulsante <strong>Aggiungi prodotto</strong>: filtra per <em>Tutti</em> (intera collezione PE27), <em>Carrello</em> (solo i prodotti nel carrello attivo) o <em>Ordine</em> (prodotti di un ordine specifico). Nella stessa schermata puoi affinare con i filtri Famiglia, Colore, Classe e Sottoclasse. I codici prodotto non sono visibili nel Visual: tocca il nome di un prodotto per aprire la scheda anagrafica con taglia e codice corrispondente. Le taglie disponibili (XXS→XXL) sono evidenziate; quelle assenti per quel prodotto sono semitrasparenti. Le foto appaiono direttamente nel rendering (barre, mensole, frontali). Il tipo viene riconosciuto automaticamente.</Bullet>
