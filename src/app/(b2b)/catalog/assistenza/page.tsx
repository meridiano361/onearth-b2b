    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="space-y-8">
        ...
        <section id="moda-pe27" className="bg-white border border-border rounded-lg p-5 sm:p-6 scroll-mt-6">
          ...
          <ul className="space-y-2">
            <Bullet><span className="font-medium">Accesso:</span> dalla home dell&apos;app tocca il quadrato <em>MODA PE27</em> per entrare nella sezione. Da lì puoi navigare a Catalogo, Preferiti, Pareti Attrezzate, Carrelli e Ordini della collezione.</Bullet>
