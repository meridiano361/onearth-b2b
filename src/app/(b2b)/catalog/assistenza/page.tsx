// AGGIORNATO: 2026-07-01 (Visual: scheda compatta, taglie XXS-XXL, foto in rendering, ruota cromatica integrata)
      ...
      <div className="space-y-8">
        ...
        <section id="moda-pe27" className="bg-white border border-border rounded-lg p-5 sm:p-6 scroll-mt-6">
          ...
          <ul className="space-y-2">
            ...
            <Bullet><span className="font-medium">Visual:</span> simula l&apos;esposizione in negozio costruendo layout con barre appenderia, mensole e frontali. L&apos;anteprima è fissa in cima alla pagina e non scorre: usa i pulsanti <strong>+/−</strong> per zoomare e tocca un elemento nell&apos;anteprima per espandere automaticamente la scheda di modifica corrispondente. Le foto dei prodotti appaiono direttamente nel rendering (capi di costa sulle barre, borse/accessori sulle mensole, figure intere sui frontali). La scheda di ogni prodotto mostra le taglie disponibili (XXS→XXL): quelle non disponibili per quel prodotto sono semitrasparenti e non selezionabili. In fondo alla scheda trovi i tre abbinamenti cromatici suggeriti (complementare + due analoghi) derivati dal colore del prodotto, con un link alla Ruota Cromatica completa. Il tipo (top, bottom, abito, capospalla, borsa, accessorio, bijou…) viene riconosciuto automaticamente dal catalogo.</Bullet>
